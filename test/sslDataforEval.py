...
def generate_sound_source_localization_dataset(
    ...
    output_base = "/home/zengkehan/voice/speech_dataset"
    ...
    while sample_idx < num_samples:
        ...
        theta = np.radians(sample_idx*5+2)
        phi = np.radians(sample_idx*5+2)
